...
python pipeline_scalar_charge.py  --M 1e6 --mu 100 --a 0.99 --e_f 0.0 --T 0.45 --z 0.5 --psd_file ../pipeline/TDI2_AE_psd.npy --dt 10.0 --use_gpu --N_montecarlo 1000 --device 0 --use_scalar_charge --Lambda 0.0 --ScalarMass 0.0  --repo scalar_results/massless_montecarlo/M1e6mu100a099z05dt10T45derorder8 --calculate_fisher 1
